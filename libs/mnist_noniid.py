#Source: https://github.com/jeremy313/non-iid-dataset-for-personalized-federated-learning
...
def mnist_extr_noniid(train_dataset, test_dataset, num_users, n_class, num_samples, rate_unbalance):
    ...
    num_classes = 10
    num_imgs_perc_test, num_imgs_test_total = int(60000/num_samples), num_samples # Fix this for test.
    ...
    #idxs_labels_test = np.vstack((idxs_test, labels_test)) Also Fix this for test.
    idxs_labels_test = np.vstack((idxs, labels))
